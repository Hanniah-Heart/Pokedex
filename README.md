...
You can now paginate through the map, explore specific locations, and attempt to catch pokemon.

This REPL program now supports 6 recognized commands (seen under help command), and handles

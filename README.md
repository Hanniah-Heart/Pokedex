...
You can now paginate through the map, explore specific locations, attempt to catch pokemon, and
inspect to see the stats of a pokemon you've caught.

This REPL program now supports 7 recognized commands (seen under help command), and handles
errors, piped inputs with End-of-File's, and empty user input. Anything collected from the
